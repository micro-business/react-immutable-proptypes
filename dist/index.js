...
function createKeysTypeChecker(typeChecker) {
  ...
  function validate(props, propName, componentName, location, propFullName) {
    ...
    for (var _len3 = arguments.length, rest = Array(_len3 > 5 ? _len3 - 5 : 0), _key3 = 5; _key3 < _len3; _key3++) {
...
function createMapOfTypeCheckerFactory(valuesTypeChecker, keysTypeChecker, immutableClassName, immutableClassTypeValidator) {
  function validate() {
    return createIterableTypeChecker(valuesTypeChecker, immutableClassName, immutableClassTypeValidator).apply(undefined, arguments) || keysTypeChecker && createKeysTypeChecker(keysTypeChecker).apply(undefined, arguments);
  }
...
function createRecordOfTypeChecker(recordKeys) {
  function validate(props, propName, componentName, location, propFullName) {
    ...
    for (var _len4 = arguments.length, rest = Array(_len4 > 5 ? _len4 - 5 : 0), _key4 = 5; _key4 < _len4; _key4++) {
...
function createShapeTypeChecker(shapeTypes) {
  ...
  function validate(props, propName, componentName, location, propFullName) {
    ...
    for (var _len5 = arguments.length, rest = Array(_len5 > 5 ? _len5 - 5 : 0), _key5 = 5; _key5 < _len5; _key5++) {
